...
public class mayinYerlestir extends mayinTarlasiOyun implements ActionListener{
 ...
 int hakSayisi;
  ...
  public void actionPerformed(ActionEvent e) {
     ...
     if(mayin[point.x][point.y]<0){
        ...
        oyunBitti();
         ...
         if("doldur"==buttons[point.x][point.y].getActionCommand()){                     
         ...
         if(mayin[point.x][point.y]>3) {
          ...
          hakSayisi--;
       if(hakSayisi==0)
          JOptionPane.showMessageDialog(null,"Tebrikler Kazandın Şampiyon","Sonuc", JOptionPane.INFORMATION_MESSAGE);
  ...
  public void oyunBitti(){
      ...
      JOptionPane.showMessageDialog(null,"Kaybettin Tekrar Deneyebilirsin","Mayin",JOptionPane.INFORMATION_MESSAGE);
  ...
  public mayinYerlestir(int boyut, int mayinSayisi){
     this.boyut=boyut;
     this.mayinSayisi=mayinSayisi;
     buttons=new JButton[boyut][boyut];  
     mayin=new int[boyut][boyut]; 
     hakSayisi=this.boyut*this.boyut-this.mayinSayisi;
